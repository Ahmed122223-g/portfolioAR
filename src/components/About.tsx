      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              أتقن استخدام <span className="font-semibold text-accent">React</span> لتطوير واجهات مستخدم حديثة
              وسريعة، مع خبرة في <span className="font-semibold text-accent">Node.js</span> و{" "}
          ...
          <div className="flex justify-center md:justify-end">
            <Image
              ...
              width={300}
              height={300}
              className="rounded-full object-cover aspect-square border-4 border-accent shadow-lg hover:scale-105 transition-transform duration-300"
              priority
            />
          </div>
        </div>
